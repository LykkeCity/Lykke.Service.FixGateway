...
namespace Lykke.MarginTrading.Client.AutorestClient.Models
{
    ...
    public partial class AccountAssetPairContract
    {
        /// <summary>
        /// Initializes a new instance of the AccountAssetPairContract class.
        /// </summary>
        public AccountAssetPairContract()
        {
            CustomInit();
        }
