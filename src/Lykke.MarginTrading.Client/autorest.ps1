...
autorest --input-file=http://mt-backend-demo.lykke-mt.svc.cluster.local/swagger/v1/swagger.json --csharp --output-folder=./AutorestClient --namespace=Lykke.MarginTrading.Client.AutorestClient --sync-methods=none  --override-client-name=MarginTradingApi